...
class SubscriptionFilter(django_filters.FilterSet):
    start_date = django_filters.NumberFilter(lookup_expr='year', label=False,widget=forms.TextInput(attrs={
            'class': 'block w-44 sm:w-1/2 py-2 pl-10 border border-gray-300 text-gray-700 rounded-lg focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm',  # Tailwind classes
            'placeholder': 'Έτος',
        }))
